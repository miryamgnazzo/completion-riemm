function A = eval_all(values, pi0, en, fun, Qh)
%EVAL_ALL  Evaluate the full tensor on the grid VALUES = {tvec, theta1, ...}.
%   FUN is an optional measure handle, QH an optional generator handle.
...
for k = 1:length(all_ind)
    ...
    v = fiber_time(tvec, param, pi0, en, fun, Qh); %11-06
