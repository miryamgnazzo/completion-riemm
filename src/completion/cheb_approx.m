...
%CHEB_APPROX  Chebyshev interpolant used as starting point for completion.
%   F holds the measure evaluated on a Chebyshev grid, INTERVALS is a cell
%   array with the domain of each variable.
